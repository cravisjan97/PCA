...
cd ('C:\Users\C RAVI SUNDARAM\Desktop\ravi\pss projects\face reg\TestImage');
while (1==1)
    choice=menu('Face Recognition',...
                ...
                'Exit');
    if (choice ==1)
       try cd ('C:\Users\C RAVI SUNDARAM\Desktop\ravi\pss projects\face reg\TestImage');close all; end; 
